...
export const NewsCard = ({source, title, description, publishedAt, url, urlToImage }) => {
  return (
    <article className="">
        <span  className="flex flex-col rounded border bg-white transition hover:bg-gray-200">
        <div className="">
            <img src={urlToImage || '/images/news_fallback.jpg'} className="w-full object-cover" />
        </div>

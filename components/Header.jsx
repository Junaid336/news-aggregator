...
import { HiArrowNarrowRight as  ArrowPathIcon} from "react-icons/hi";
import { HiOutlineMenu as Bars3Icon } from "react-icons/hi";
import { HiOutlineX as XMarkIcon} from "react-icons/hi";
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">News Aggregaotr</span>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          <Link href="/categories/general" className="text-sm font-semibold leading-6 text-gray-900">
            General
          </Link>
          <Link href="/categories/sports" className="text-sm font-semibold leading-6 text-gray-900">
            Sports
          </Link>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <SearchBar />
          <Link href="/auth" className="text-sm font-semibold leading-6 text-gray-900 ml-3">
